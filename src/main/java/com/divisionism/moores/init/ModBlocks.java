...
public class ModBlocks {
	...
	public static final RegistryObject<Block> CRYSTAL_MEF = BLOCKS.register("crystal_mef",
			() -> new CrystalMef(BlockBehaviour.Properties.of(Material.STONE).strength(100f, 100f).requiresCorrectToolForDrops()
					.jumpFactor(1f).friction(0.5f).dynamicShape()));
	public static final RegistryObject<Block> YES_BLOCK = BLOCKS.register("yes_block",
			() -> new Block(BlockBehaviour.Properties.of(Material.STONE).strength(100f, 100f).requiresCorrectToolForDrops()
	...
	public static final RegistryObject<Block> BLAZING_BLACKSTONE = BLOCKS.register("blazing_blackstone",
			() -> new BlazingBlackstone(BlockBehaviour.Properties.of(Material.STONE).strength(20f).requiresCorrectToolForDrops().lightLevel((state) -> {
				return 10;
			})));
